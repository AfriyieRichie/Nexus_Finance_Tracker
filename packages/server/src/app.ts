...
import { purchaseOrdersRouter } from './modules/purchase-orders/po.routes';
import { paymentVouchersRouter } from './modules/payment-vouchers/pv.routes';
...
app.use('/api/v1/organisations/:organisationId/purchase-orders', purchaseOrdersRouter);
app.use('/api/v1/organisations/:organisationId/payment-vouchers', paymentVouchersRouter);
