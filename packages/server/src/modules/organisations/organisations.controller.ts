...
export const create = asyncHandler(async (req: Request, res: Response) => {
  ...
  const org = await orgService.createOrganisation(input, req.user!.sub);
...
export const inviteUser = asyncHandler(async (req: Request, res: Response) => {
  ...
  const result = await orgService.inviteUser(req.params.organisationId, input, req.user!.sub);
...
export const removeUser = asyncHandler(async (req: Request, res: Response) => {
  await orgService.removeUser(req.params.organisationId, req.params.userId, req.user!.sub);
