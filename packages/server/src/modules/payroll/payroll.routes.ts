...
payrollRouter.post('/pay-elements/bulk',        requireRole(FINANCE_MANAGER), ctrl.bulkAssignComponents);
...
payrollRouter.get('/reports/paye-schedule',     requireRole(REPORT_VIEWER),   ctrl.reportPayeSchedule);
