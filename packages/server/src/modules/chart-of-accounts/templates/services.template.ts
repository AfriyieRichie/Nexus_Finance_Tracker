...
export const servicesTemplate: CoaTemplate = {
  ...
  accounts: [
    ...
    { code: '121110', name: 'Office Furniture — Accum. Depreciation', class: AccountClass.ASSET, type: AccountType.FIXED_ASSET, parentCode: '121000', level: 4 },
    { code: '121200', name: 'Computer Equipment — Cost', class: AccountClass.ASSET, type: AccountType.FIXED_ASSET, parentCode: '121000', level: 4 },
    { code: '121210', name: 'Computer Equipment — Accum. Depreciation', class: AccountClass.ASSET, type: AccountType.FIXED_ASSET, parentCode: '121000', level: 4 },
    { code: '121300', name: 'Motor Vehicles — Cost', class: AccountClass.ASSET, type: AccountType.FIXED_ASSET, parentCode: '121000', level: 4 },
    { code: '121310', name: 'Motor Vehicles — Accum. Depreciation', class: AccountClass.ASSET, type: AccountType.FIXED_ASSET, parentCode: '121000', level: 4 },
